...
namespace PollyCachingDepartmentsExample
{
    public class Startup
    {
        ...
        private IPolicyRegistry<string> _myPolicyRegistry;
        ...
        {
            _myPolicyRegistry = new PolicyRegistry();
            ...
            services.AddSingleton(_myPolicyRegistry);
            services.AddMvc();
        }
